...
// let IDcountry = results.find( item => item.id == id);
//   let contry = IDcountry.shipAddress.country;
// console.log(contry);
// }
...
//   console.log(results.find((item) => item.shipAddress.country == x));
// }
...
//   let IDshipName = results.find((item) => item.id == id);
//   let shipName = IDshipName.shipName;
//   let country = IDshipName.shipAddress.country;
//   let city = IDshipName.shipAddress.city;
...
// function detal (id){
// let IDdetal = results.find( item => item.id == id);
// let details = IDdetal.details.length;
...
// function detal(id) {
//   let IDdetal = results.find((item) => item.id == id);
//   let detail = IDdetal.details;
//   let sum = 0;
//   detail.forEach((element) => {
//     sum += (1 - element.discount) * element.unitPrice * element.quantity;
//   });
//   console.log(sum);
// }
